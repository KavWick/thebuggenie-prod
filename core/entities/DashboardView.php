<?php
    ...
    class DashboardView extends IdentifiableScoped
    {
        ...
        public static function getAvailableViews($target_type)
        {
            ...
            {
                case self::TYPE_USER:
                    $searches['info'][self::VIEW_SPENT_TIME] = array(0 => array('title' => $i18n->__("Time spent recently (last 30 days)"), 'description' => $i18n->__('A widget that shows time spent in last 30 days')));
        ...
        public function getTemplate()
        {
            switch ($this->getType())
            {
                ...
                case self::VIEW_SPENT_TIME:
                    return 'main/dashboardviewspenttime';
