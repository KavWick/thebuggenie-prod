<?php
    ...
    class Components extends framework\ActionComponent
    {
        ...
        public function componentDashboardViewSpentTime()
        {
	    // default to last month (31 days)
	    $startFrom = NOW - 3600*24*31;
	    $this->spenttimes = tables\IssueSpentTimes::getTable()->getSpentTimeByDateAndUserID($startFrom, null, $this->getUser()->getID());
        }
