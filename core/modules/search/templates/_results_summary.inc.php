<div class="results_summary">
    ...
    <?php if( \thebuggenie\core\framework\Context::getCurrentProject() && \thebuggenie\core\framework\Context::getCurrentProject()->canSeeTimeSpent()): echo __('Total current effort: %details', array('%details' => '<span class="issue_spent_time_summary">'.\thebuggenie\core\entities\Issue::getFormattedTime($current_spent_time, false).'</span>')); endif; ?><br>
</div>
